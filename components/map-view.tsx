...
export default function MapView({
    ...
    const initializeMap = async () => {
      ...
      try {
        ...
        mapInstance.on("load", async () => {
          ...
          mapInstance.addControl(new mapboxgl.GeolocateControl(), "bottom-right")
  ...
  useEffect(() => {
    ...
    let filtered = pois.filter((poi) => {
      switch (poi.type) {
        case "ev-station": return filters.evStation
        case "hospital": return filters.hospital
        case "restaurant": return filters.restaurant
        case "petrol-station": return filters.petrolStation
    ...
    if (map) {
      ...
      filtered.forEach((poi) => {
        ...
        switch (poi.type) {
          case "ev-station":
            bgColor = "#22c55e"
            icon = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 7h1a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-2"/><path d="M6 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h1"/><path d="m11 7-3 5h4l-3 5"/><line x1="22" x2="22" y1="11" y2="13"/></svg>`
            break
          case "hospital":
            bgColor = "#ef4444"
            icon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-hospital-icon lucide-hospital"><path d="M12 6v4"/><path d="M14 14h-4"/><path d="M14 18h-4"/><path d="M14 8h-4"/><path d="M18 12h2a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-9a2 2 0 0 1 2-2h2"/><path d="M18 22V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v18"/></svg>`
            break
          case "restaurant":
            bgColor = "#f59e0b"
            icon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-utensils-icon lucide-utensils"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7"/></svg>`
            break
          case "petrol-station":
            bgColor = "#3b82f6"
            icon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-fuel-icon lucide-fuel"><line x1="3" x2="15" y1="22" y2="22"/><line x1="4" x2="14" y1="9" y2="9"/><path d="M14 22V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v18"/><path d="M14 13h2a2 2 0 0 1 2 2v2a2 2 0 0 0 2 2a2 2 0 0 0 2-2V9.83a2 2 0 0 0-.59-1.42L18 5"/></svg>`
            break
        }
        ...
        const popup = new mapboxgl.Popup({
          ...
          <div class="p-3">
            ...
            ${poi.status ? 
              `<p class="text-sm mt-1"><span class="font-medium">Status:</span> ${poi.status}</p>` : ''}
  ...
  }, [pois, filters, map, favorites, showFavorites])
        ...
        <div className="absolute top-16 left-4 z-20 bg-white rounded-lg shadow-lg p-4 w-80">
          ...
          {searchResults.length > 0 && (
            <div className="border rounded-md overflow-hidden bg-white">
              <p className="px-3 py-2 text-xs font-medium text-gray-500 bg-gray-50 border-b">
                Search results
              </p>
      ...
      {showFavorites && filteredPOIs.length === 0 && favorites.length > 0 && (
        <div className="absolute top-24 left-4 z-10 bg-white rounded-lg shadow-md p-4 max-w-xs">
          <div className="flex flex-col items-center py-4">
            ...
            <p className="text-center">No favorites visible in this area. Adjust filters or zoom out to see your favorites.</p>
          </div>
        </div>
      )}
    </div>
